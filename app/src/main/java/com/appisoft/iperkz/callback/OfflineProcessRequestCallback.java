...
public class OfflineProcessRequestCallback extends UrlRequest.Callback {

    private static final String TAG = "OfflineProcessRequest";
    ...
    private MutableLiveData<SimpleResponse> offlineRequestResult;

    public OfflineProcessRequestCallback(Context context, MutableLiveData<SimpleResponse> offlineRequestResult ) {
        this.mainActivity = (Activity) context;
        this.offlineRequestResult = offlineRequestResult;
    }
   ...
   //     Log.i(TAG, "onSucceeded method called." +bytesReceived);
        ...
        mainActivity.runOnUiThread(new Runnable() {
            public void run() {
                offlineRequestResult.setValue(statusResponse);
            }
        });
    }
